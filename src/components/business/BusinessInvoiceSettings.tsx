...
> = {
  modern: {
    label: 'Modern',
    desc: 'Bold header with gradient accent bar and clean sections',
    ...
    return (
      <div className="w-full h-36 rounded-lg overflow-hidden border border-white/[0.06] bg-[#0d0d1a] text-[8px] text-white/60 flex flex-col">
        ...
        <div className="px-2 py-1 space-y-1 flex-1">
          ...
          <div
            className="h-1.5 w-12 rounded mt-auto ml-auto"
  ...
  return (
    <div className="flex items-center gap-3">
      <button
        ...
        className="relative h-10 w-10 rounded-lg border border-white/[0.1] shrink-0 cursor-pointer transition-transform hover:scale-105 active:scale-95"
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-1.5 mt-1">
          ...
          <Input
            ...
            className="h-8 bg-white/[0.05] border-white/[0.1] text-white text-xs font-mono w-28"
            maxLength={7}
          />
        </div>
      </div>
...
function LivePreview({ form }: { form: InvoiceSettingsForm }) {
  ...
  if (form.template === 'modern') {
    return (
      <div className="w-full rounded-xl overflow-hidden border border-white/[0.06] bg-[#0d0d1a] text-[10px] text-white/70 shadow-lg">
        {/* Header */}
        <div
        ...
        <div className="p-3 space-y-2">
          ...
          <div className="rounded-lg border border-white/[0.06] overflow-hidden">
            <div
              className="grid grid-cols-12 gap-0 px-2 py-1 text-[8px] font-semibold text-white/50 uppercase tracking-wider"
            ...
            {sampleItems.map((item, i) => (
              <div
                key={i}
                className={cn(
                  'grid grid-cols-12 gap-0 px-2 py-1 text-[9px]',
                  i < sampleItems.length - 1 ? 'border-b border-white/[0.03]' : '',
                )}
              >
    ...
    return (
      <div className="w-full rounded-xl overflow-hidden border border-white/[0.06] bg-[#0d0d1a] text-[10px] text-white/70 shadow-lg">
        <div className="px-4 pt-3 pb-2 text-center border-b border-white/[0.06]">
          <p className="font-bold text-xs tracking-widest uppercase" style={{ color: accent }}>
            {bizName}
          </p>
  ...
  return (
    <div className="w-full rounded-xl overflow-hidden border border-white/[0.06] bg-[#0d0d1a] text-[10px] text-white/70 shadow-lg">
      ...
      <div className="px-4 pb-3 space-y-2">
        ...
        {form.footerText && (
          <p className="text-white/25 text-[7px] italic">{form.footerText}</p>
        )}
      </div>
    </div>
  );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h2 className="text-lg font-bold text-white flex items-center gap-2">
            <Settings className="h-5 w-5 text-[#BB86FC]" />
            Invoice Settings
          </h2>
        ...
        <Button
          ...
          className="bg-[#BB86FC] text-black hover:bg-[#9B6FDB] disabled:opacity-40"
        >
          {saving ? (
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {(Object.keys(TEMPLATE_META) as TemplateType[]).map((type) => {
                    ...
                    return (
                      ...
                      >
                        {selected && (
                          <div className="absolute -top-1.5 -right-1.5 h-5 w-5 rounded-full bg-[#BB86FC] flex items-center justify-center">
                    ...
                    {form.logoUrl ? (
                      <div className="relative group">
                        <img
                          src={form.logoUrl}
                          alt="Business logo"
                          className="h-[100px] w-[100px] object-cover rounded-xl border border-white/[0.1]"
                        />
                        <button
                          type="button"
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center h-[100px] w-[100px] rounded-xl border-2 border-dashed border-white/[0.1] hover:border-[#BB86FC]/50 bg-white/[0.02] transition-colors cursor-pointer"
                      >
                    ...
                    {form.signatureUrl ? (
                      <div className="relative group">
                        <img
                          ...
                          alt="Signature"
                          className="h-[100px] max-w-[200px] object-contain rounded-xl border border-white/[0.1] bg-white/[0.02]"
                        />
                        <button
                          type="button"
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center h-[100px] w-[200px] rounded-xl border-2 border-dashed border-white/[0.1] hover:border-[#BB86FC]/50 bg-white/[0.02] transition-colors cursor-pointer"
                      >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      className="bg-white/[0.05] border-white/[0.1] text-white placeholder:text-white/30 min-h-[60px] resize-none"
                    />
                  </div>
            ...
            <Card className="bg-[#1A1A2E] border border-white/[0.06] rounded-2xl">
              <CardContent className="p-4 sm:p-6">
                <SectionHeader icon={FileText} title="Invoice Footer" color="#BB86FC" />
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
          ...
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-4">
              <Card className="bg-[#1A1A2E] border border-white/[0.06] rounded-2xl">
                <CardContent className="p-4 sm:p-6">
                  <SectionHeader icon={Eye} title="Live Preview" color="#03DAC6" />
                  <div className="space-y-3">
                    ...
                    {(form.bankName || form.accountNumber || form.accountHolderName) && (
                      <div className="mt-3 rounded-lg bg-white/[0.03] p-2.5 border border-white/[0.04]">
