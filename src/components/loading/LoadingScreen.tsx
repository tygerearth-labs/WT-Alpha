...
export function LoadingScreen() {
  ...
  const [statusText, setStatusText] = useState('Memverifikasi sesi...');

  useEffect(() => {
    const stages = [
      { at: 0, text: 'Memverifikasi sesi...' },
      { at: 25, text: 'Menyiapkan data...' },
      { at: 50, text: 'Memuat dashboard...' },
      { at: 75, text: 'Hampir selesai...' },
      { at: 95, text: 'Selamat datang!' },
    ];
